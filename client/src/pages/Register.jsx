    ...
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="card w-full max-w-md p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">开启你的飞钓绑制档案</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input value={nickname} onChange={(e) => setNickname(e.target.value)} className="input" required />
          </div>
          <div>
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          已有账号？<Link to="/login" className="text-flytie-primary hover:underline">登录</Link>
        </p>
      </div>
    </div>
  );
